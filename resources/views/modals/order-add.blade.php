<!-- Main modal -->
<div id="modalPlaceOrder" tabindex="-1" aria-hidden="true" class="font-text fixed top-0 left-0 right-0 z-50 hidden 
    ...
    <div class="relative p-4 w-96 h-full md:h-auto -mt-44">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="modalPlaceOrder">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                </svg>
            </button>
            <div class="py-6 px-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Place New Order</h3>
                <form role="form" action="{{ route('orders.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body divide-y divide-slate-200">
                        <div class="-mt-1 flex space-y-1 flex-col justify-between py-2 w-full">
                            ...
                            <input id="orderName" name="name" readonly class="bg-white rounded-lg w-full">
                        </div>
