<!-- Main modal -->
<div id="modalAddItem" tabindex="-1" aria-hidden="true" class="font-text fixed top-0 left-0 right-0 z-50 hidden 
    ...
    <div class="relative p-4 w-96 h-full md:h-auto -mt-44">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="modalAddItem">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                </svg>
            </button>
            <div class="py-6 px-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Enter New Item</h3>
                <form role="form" action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input id="id" hidden type="text" name="id">
                    <div class="modal-body divide-y divide-slate-200">
                        <div class="-mt-1 flex flex-col justify-between w-full">
                            <div class="flex flex-row justify-between">
                                <label class="mt-3 text-xs text-gray-500 dark:text-gray-300">Name</label>
                            </div>
                            <div class="w-full">
                                <input id="name" name="name" required class="bg-gray-200 rounded-lg outline-none w-full
                                        focus-within:outline border-none focus:outline-orange-500 p-2 my-2 mt-4">
                            </div>
                        </div>
                        <div class="-mt-1 flex flex-col justify-between w-full">
                            <div class="flex flex-row justify-between">
                                <label class="mt-3 text-xs text-gray-500 dark:text-gray-300">Category</label>
                            </div>
                            <div class="w-full">
                                <select id="item_category_id" name="item_category_id" required class="bg-gray-200 rounded-lg outline-none w-full
                                        focus-within:outline border-none focus:outline-orange-500 p-2 my-2 mt-4">
                                    <option selected value="1">Computer Technology</option>
                                    <option value="2">Computer Accessories</option>
                                    <option value="3">Office Machines</option>
                                    <option value="4">Office Furniture Supplies</option>
                                    <option value="5">Office Essentials</option>
                                    <option value="6">Breakroom</option>
                                </select>
                            </div>
                        </div>
                        <div class="-mt-1 flex flex-col justify-between w-full">
                            <div class="flex flex-row justify-between">
                                <label class="mt-3 text-xs text-gray-500 dark:text-gray-300">Brand</label>
                            </div>
                            <div class="w-full">
                                <input id="brand" name="brand" type="" class="bg-gray-200 rounded-lg outline-none w-full
                                        focus-within:outline border-none focus:outline-orange-500 p-2 my-2 mt-4">
                            </div>
                        </div>
                        ...
                        <div class="-mt-1 flex flex-col justify-between w-full">
                            ...
                            <div class="w-full">
                                <input id="remarks" name="remarks" class="bg-gray-200 rounded-lg outline-none w-full
                                        focus-within:outline border-none focus:outline-orange-500 p-2 my-2 mt-4">
                            </div>
                        </div>
                    ...
                    <div class="modal-footer mt-5 space-x-1">
                        ...
                        <button data-modal-toggle="modalAddItem" type="button" class="text-gray-500 bg-white 
